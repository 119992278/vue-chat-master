...
export default {
  ...
  methods: {
    ...
    isFriend () {
      axios
        ...
        .then(res => {
          if (res.data.data.isMyFriend) {
            this.isMyFriend = true
            this.remark = res.data.data.isMyFriend.remark
          }
          if (res.data.data.isHisFriend) {
  ...
  async created () {
    ...
    this.isMe =
      parseInt(this.myInfo.user_id) === parseInt(this.$route.params.user_id)
