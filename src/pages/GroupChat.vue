...
<script src="http://ooytyiziz.bkt.clouddn.com/socket.io.js"></script>
<script>
...
export default {
  ...
  methods: {
    ...
    addGroupUserRelation () {
      axios
        .post('/api/v1/group_chat_relation', {
          groupId: this.groupInfo.groupId
        })
        .then(res => {
  ...
  async created () {
    ...
    this.inputMsg = '我是' + this.userInfo.name + ',大家好'
